...
This chapter presents the ESR\index{Electron Spin Resonance (ESR)}\index{Electron Paramagnetic Resonance (EPR)}\index{Electron Spin Resonance (ESR)}\index{Electron Paramagnetic Resonance (EPR)} spectrums for SiC and CdTe for both computational and experimental methods. The results of these two methods are then compared and contrasted and their strengths analyzed.
...
\begin{figure}
    \caption[ESR\index{Electron Spin Resonance (ESR)}\index{Electron Paramagnetic Resonance (EPR)}\index{Electron Spin Resonance (ESR)}\index{Electron Paramagnetic Resonance (EPR)} computational model for CdTe\index{cadmium telluride (CdTe)}]{\label{fig:CdTeModel}
     This is the figure description.}
 \end{figure}
